...
import { ArrowRight, Phone, Mail, MapPin, ArrowLeft } from 'lucide-react';
...
const MobileMenu = ({ isOpen, onClose }) => {
  return (
    <>
      ...
      <div 
        className={`
          fixed inset-0 bg-black/60 backdrop-blur-sm transition-opacity duration-300 z-30
      ...
      <div 
        className={`
          fixed top-0 right-0 w-full max-w-sm h-full bg-gray-900 opacity-90 transform transition-transform duration-500 ease-out z-40
